...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget_2s = PlotWidget(self.tab_2)
        ...
        self.widget_3s = PlotWidget(self.tab_3)
